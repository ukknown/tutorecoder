  ...
  <el-row
    ...
    <div class="hide-on-small">
      ...
      <div class="tool-wrapper">
        ...
        <div class="button-wrapper" v-if="this.$store.getters['accountStore/getToken']">
          <el-button type="primary" @click="clickLogout"><i class="el-icon-switch-button"></i>로그아웃</el-button>
        </div>
        <div class="button-wrapper" v-else>
          <el-button @click="clickSignin" icon="el-icon-circle-plus-outline">회원가입</el-button>
    ...
    <div class="hide-on-big">
      ...
      <div class="mobile-sidebar-wrapper" v-if="!state.isCollapse">
        <div class="mobile-sidebar">
          <div class="mobile-sidebar-tool-wrapper" v-if="this.$store.getters['accountStore/getToken']">
            <div class="logo-wrapper"><div class="ic ic-logo"/></div>
            <el-button type="primary" @click="clickLogout" class="mobile-sidebar-btn logout-btn"><i class="el-icon-switch-button"></i>로그아웃</el-button>
          </div>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    return { state, menuSelect, clickLogo, clickLogin, changeCollapse, clickSignin, clickLogout }
  }
}
</script>
<style>
